...
const BUILTIN_SUBAGENT_KINDS: readonly SubagentKindConfig[] = [
  ...
  },
  {
    id: "code-review",
    name: "Code Review",
    promptPath: "agents/code-review.md",
  ...
  },
  {
    ...
    promptPath: "agents/quality-analyst.md",
  ...
  },
  {
    id: "design-review",
    name: "Design Review",
    promptPath: "agents/design-review.md",
    description:
      "reviews HTML design artifacts (and screenshots) against DESIGN.md and craft rules",
    allowedTools: DEFAULT_ALLOWED_TOOLS,
    readOnly: true,
    inheritBasePrompt: true,
  },
