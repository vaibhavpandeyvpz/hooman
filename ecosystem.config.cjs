...
module.exports = {
  apps: [
    ...
    },
    {
      ...
      cwd: ".",
      script: "npx",
      args: "tsx apps/backend/src/workers/slack.ts",
      env: { NODE_ENV: "production" },
    },
    {
      name: "whatsapp",
      cwd: ".",
      script: "npx",
      args: "tsx apps/backend/src/workers/whatsapp.ts",
      env: { NODE_ENV: "production" },
    },
    {
      name: "cron",
      cwd: ".",
      script: "npx",
      args: "tsx apps/backend/src/workers/cron.ts",
      env: { NODE_ENV: "production" },
    },
    {
      name: "event-queue",
      cwd: ".",
      script: "npx",
      args: "tsx apps/backend/src/workers/event-queue.ts",
      env: { NODE_ENV: "production" },
    },
  ],
};
